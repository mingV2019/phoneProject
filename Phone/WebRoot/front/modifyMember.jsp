...
<body id="body">
	...
	<div class="main">
		<div class="clear w960">
			...
			<div class="box">
				<form id="member-registration" action="<%=basePath%>memberservlet?action=editPassword" method="post" id="frm" name="frm" onsubmit="return on_submit(this)">
				...
				<div class="card J_card">
					...
					<div class="input-group J_input-group">
						<input type="text" id="phone" name="tel" placeholder="请输入手机号" class="input tel J_telInput" />
					...
					<div class="choose">
						<label> <input type="checkbox" id="agreement" value="0" checked="checked" class="ckbox" />同意用户协议 </label> 
						<label style="margin-left:10px;"> <a target="_blank" style="color:red;" href="#">隐私政策</a> </label>
					</div>
					<a href="javascript:document.frm.submit();" id="loginBtn" class="main-button">点击修改</a>
				</div>
				</form>
			</div>
		</div>
